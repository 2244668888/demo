...
@endsection
@section('button')
    <a type="button" class="btn btn-info" href="{{ route('department.create') }}">
                    ...
                    <tbody>
                        {{-- @foreach ($departments as $department)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info btn-sm" href="{{ route('department.edit', $department->id) }}"><i
                                            class="bi bi-pencil"></i>
                                    </a>
                                    <a class="btn btn-success btn-sm"
                                        href="{{ route('department.view', $department->id) }}"><i class="bi bi-eye"></i>
                                    </a>
                                    <a class="btn btn-danger btn-icon btn-sm"
                                        href="{{ route('department.destroy', $department->id) }}"><i
                                            class="bi bi-trash"></i>
                                    </a>
                                </td>
                            </tr>

...
@section('content')
                ...
                <div class="col-lg-3 col-sm-4 col-12">
                    <div class="mb-3">
                        ...
                        <input type="text" readonly
                            value="{{ Carbon\Carbon::parse($production->planned_date)->format('d-m-Y') }}" name="po_date"
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-4 col-12">
                    <div class="mb-3">
                        ...
                        <input type="text" readonly value="{{ $count }}" name="report_qty" id="report_qty"
                            class="form-control">
                    </div>
                </div>
                <div class="col-lg-3 col-sm-4 col-12">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" readonly name="total_good" id="total_good"
                                            class="form-control" value="{{ $totalMachineCount - $totalRejectCount }}">
                                    </td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><input type="text" readonly name="qc_total_total" id="qc_total_total"
                                            class="form-control" value="{{ $production->qc_produced }}"></td>
                                    <td><input type="text" readonly name="qc_total_reject" id="qc_total_reject"
                                            class="form-control" value="{{ $production->qc_rejected_qty }}"></td>
                                    <td><input type="text" readonly name="qc_total_good" id="qc_total_good"
                                            class="form-control" value="{{ $production->qc_good_qty }}"></td>
                                ...
                                <tr>
                                        <td>Grand Total</td>
                                        <td><input type="text" readonly name="" id="qc_total_total"
                                                class="form-control" value="{{ $production->qc_produced }}"></td>
                                        <td><input type="text" readonly name="" id="qc_total_reject"
                                                class="form-control" value="{{$production->qc_rejected_qty + $totalRejectCount }}"></td>
                                        <td><input type="text" readonly name="" id="qc_total_good"
                                                class="form-control" value="{{ $production->qc_produced - ($production->qc_rejected_qty + $totalRejectCount) }}"></td>
                                        <td></td>
                                        <td></td>
                                    </tr>
                            </tbody>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var qc_rejection = @json($qc_rejection);
            var shift_rejection = @json($shift_rejection);
            qc_rejection.forEach(element => {
                let data = sessionStorage.getItem(`modalData1`);
                if (!data) {
                    data = [];
                } else {
            ...
            if (storedData1) {
                ...
                storedData1.forEach(element => {
                    ...
                    rejectionTable1.row.add([
                        `<input readonly type="number" class="form-control qty1" value="${element.qty}">`,
                        `<select disbled class="form-control rejection_type">${optionsHtml}</select>`,
                        `<input readonly type="text" class="form-control comments" value="${element.comments}">`
                    ]).draw(false);
                });
            } else {
                let optionsHtml = '';
                ...
                rejectionTable1.row.add([
                    `<input readonly type="number" class="form-control qty1" value="">`,
                    `<select disabled class="form-control rejection_type">${optionsHtml}</select>`,
                    `<input readonly type="text" class="form-control comments" value="">`
                ]).draw(false);
            }

    ...
    <script>
        ...
        function order_change() {
            ...
            if (order) {
                ...
                // Assuming order.order_month is in the format "YYYY-MM"
                const orderMonth = order.order_month;

                // Create a new Date object from the orderMonth string
                ...
                // Set the formatted date as the text of the .modal-title-2 element
                $('.modal-title-2').text(formattedDate);
        ...
        function openCalendar(row, product_id) {
            ...
            var [year, month] = order_month.split('-').map(Number);
        ...
        function initializeCalendar(month, year) {
            ...
            for (let day = 1; day <= daysInMonth; day++) {
                ...
                dayCell.innerHTML = `<span>${day}</span><input readonly type="number" min="0" class="form-control"/>`;

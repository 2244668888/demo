...
@section('content')
    ...
    <div class="card">
        <form method="post" action="{{ route('stock_relocation.update', $stock_relocation->id) }}"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" rows="1" class="form-control">{{ $stock_relocation->description }}</textarea>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <select name="previous_location" disabled id="previous_location" class="form-select">
                    ...
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <select name="new_location" disabled id="new_location" class="form-select">
                                <option value="" selected disabled>Please Select</option>
                                @foreach ($locations as $location)
                                    <option data-area-id="{{ $location->area->id }}"
                                ...
                                @foreach ($stock_relocation_details as $stock_relocation_detail)
                                    <tr>
                                        ...
                                        <td><input type="number" readonly class="form-control available_qty"
                                                ...
                                                class="product_id" value="{{ $stock_relocation_detail->product_id }}">
                                        </td>

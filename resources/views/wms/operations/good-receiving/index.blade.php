...
@endsection
@section('button')
    <a type="button" class="btn btn-info" href="{{ route('good_receiving.create') }}">
                ...
                <table class="table table-bordered m-0 datatable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>
                                <input type="text" class="all_column " placeholder="search Incoming Qty">
                            </th>
                            <th>
                            ...
                            <th>
                                <input type="text" class="all_column " placeholder="search Received By">
                            </th>
                            <th>

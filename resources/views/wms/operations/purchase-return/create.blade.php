...
@section('content')
    <div class="card">
        <form method="post" action="{{ route('purchase_return.store') }}" enctype="multipart/form-data" id="myForm">
            @csrf
            <div class="card-body">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <select name="po_id" onchange="order_change()" id="po_id" class="form-select">
                    ...
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <select name="for_office" id="for_office" class="form-select">
                                <option value="" selected disabled>Please Select</option>
                                <option value="For Office Use" @selected(old('for_office') == 'For Office Use')>For Office Use</option>
                                <option value="Return For Credit" @selected(old('for_office') == 'Return For Credit')>Return For Credit</option>
                                <option value="Return For Replacement" @selected(old('for_office') == 'Return For Replacement')>Return For Replacement
                                </option>
                                <option value="Good Loan Return" @selected(old('for_office') == 'Good Loan Return')>Good Loan Return</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4 col-12">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <textarea name="remarks" id="remarks" rows="3" class="form-control" style="resize: both;">{{ old('remarks') }}</textarea>
                        </div>
                    </div>
                </div>
            ...
            if (purchase_order) {
                ...
                purchase_order.purchase_order_detail.forEach(function(detail, index) {
                    mainTable.row.add([
                        ...
                        `<input type="hidden" name="products[${mainTable.rows().count() + 1}][product_id]" class="product_id" value="${detail.product_id}"><input type="number" readonly class="form-control returned_qty" name="products[${mainTable.rows().count() + 1}][returned_qty]" value="0">`,

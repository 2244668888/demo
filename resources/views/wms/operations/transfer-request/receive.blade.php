...
@section('content')
    ...
    <form method="post" action="{{ route('transfer_request.received', $tr->id) }}" enctype="multipart/form-data">
    @csrf
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <select name="mrf_no" disabled id="mrf_no" class="form-select" >
                                <option value="" selected disabled>Manual</option>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <input type="date" name="rcv_date" id="rcv_date" value="{{ date('Y-m-d') }}" class="form-control">
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                            <label for="time" class="form-label">Receive Time</label>
                            <input type="time" name="rcv_time" value="{{ \Carbon\Carbon::now()->setTimezone('Asia/Kuala_Lumpur')->format('H:i') }}" id="time" class="form-control" />
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                            <label for="rcv_remarks" class="form-label">Receive Remarks</label>
                ...
                if( trds.find(detail => detail.product_id == $(this).val())){
                    ...
                    if (matchedDetail) {
                        ...
                        if (rcv_remarks == '' || rcv_remarks == null){
                            rcv_remarks_button = `<button type="button" class="btn btn-sm add-remarks2 btn-danger">Add</button>`;
                        }else{
                            rcv_remarks_button = `<button type="button" class="btn btn-sm add-remarks2 btn-success">Edit</button>`;
                        }
            ...
            if (storedData) {
                ...
                storedData.forEach(element => {
                    ...
                    locations.forEach(location => {
                            ...
                            lotOptionsHtml += `<option value="${location.lot_no}" ${selectedLot}>${location.lot_no}</option>`;

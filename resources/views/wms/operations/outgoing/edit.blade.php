...
@endsection
@section('content')
    <form method="post" action="{{ route('outgoing.update', $outgoing->id) }}" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-body">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-primary d-none" id="add_item" data-bs-toggle="modal"
    ...
    <script>
        ...
        $(document).ready(function() {
            var data = @json($outgoing->category);
            // let value = $(this).val();
                if (data == 1) {

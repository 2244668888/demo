...
@section('content')
    <div class="card">
        <form method="post" action="{{ route('supplier_ranking.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <select name="ranking" id="ranking" class="form-select">
                                <option value="" selected disabled>Please Select</option>
                                <option value="A" @selected(old('ranking') == 'A')>A</option>
                                <option value="B" @selected(old('ranking') == 'B')>B</option>
                                <option value="C" @selected(old('ranking') == 'C')>C</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <input type="month" name="ranking_date" value="{{ old('ranking_date') }}" id="ranking_date"
                                class="form-control">
                        </div>
                    </div>
                </div>

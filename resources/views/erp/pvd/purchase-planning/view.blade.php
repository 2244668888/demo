    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-4 col-12">
                    <div class="mb-3">
                        <label for="order_id" class="form-label">Order No <a href="#" target="_blank" id="so_view"
                                type="button">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-4 col-12">
                    <div class="mb-3">
                        ...
                        <a href="#" id="attachment" target="_blank"><i class="bi bi-download text-success"></i></a>
                    </div>
                </div>
            </div>
            <br>
                        ...
                        <tbody>
                            @foreach ($purchase_planning_detail as $purchase_planning_detail)
                                <tr>
                                    ...
                                    <td><input type="number" readonly value="{{ $purchase_planning_detail->balance }}"
            ...
            <div class="row">
                <div class="table-responsive">
                    <table class="table table-bordered m-0" id="verificationTable">
                        <thead>
                            <tr>
                                <th>Sr No</th>
                                <th>User Name</th>
                        ...
                        <tbody>
                            @foreach ($verification_details as $verification_detail)
                                @if ($verification_detail->status != 'prepared')
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td>{{ $verification_detail->user->user_name ?? '' }}</td>
                                        <td>{{ $verification_detail->department->name ?? '' }}</td>
                                        <td>{{ $verification_detail->designation->name ?? '' }}</td>
                                        <td>{{ $verification_detail->date }}</td>
                                        <td>{{ $verification_detail->status }}</td>
                                    </tr>
                                @endif
                            @endforeach
                        </tbody>

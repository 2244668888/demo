                ...
                <div class="col-lg-3 col-sm-4 col-12">
                    <div class="mb-3">
                        ...
                        <select name="supplier_id" id="supplier_id" class="form-select">
                            <option value="{{ $purchase_order->supplier_id }}" selected>{{ $purchase_order->supplier->name ?? '' }}</option>
                        </select>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-4 col-12">
                ...
                <div class="col-lg-3 col-sm-4 col-12">
                    <div class="mb-3">
                        ...
                        <select name="department_id" id="department_id" class="form-select">
                            <option value="{{ $purchase_order->department_id }}" selected>{{ $purchase_order->department->name ?? '' }}</option>
                        </select>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-4 col-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" name="products[{{ $index }}][product_id]"
                                                value="{{ $purchase_order_detail->product_id }}"><input type="date"
                                                class="form-control required_date"
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" id="wo_discount"
                                                        name="products[{{ $index }}][wo_discount]" value="1"
        ...
        <div class="card-footer">
            <div class="row">
                <div class="d-flex gap-2 justify-content-between col-12">
                    ...
                    <a type="button" target="_blank" href="{{ route('purchase_order.preview', $purchase_order->id) }}"

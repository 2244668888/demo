...
@section('content')
    <div class="card">
        <form method="post" action="{{ route('sale_price.verify_update', $saleprices->id) }}">
            @csrf
            <div class="card-body">
                <div class="row">
        ...
        <div class="modal modal-lg fade" id="Modalverify" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="post" action="{{ route('sale_price.verifyStatus', $saleprices->id) }}">
                        @csrf
        ...
        <div class="modal modal-lg fade" id="Modaldecline" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="post" action="{{ route('sale_price.declineStatus',$saleprices->id) }}">
                    @csrf
                    <div class="modal-body">
                        <table class="table">
                            <thead>
    ...
    <script>
        ...
        function product_change() {
            ...
            if (product) {
                ...
                $('#category').val(product.categories && product.categories.name ? product.categories.name : '-');

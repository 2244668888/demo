...
@endsection
@section('button')
    <a type="button" class="btn btn-info" href="{{ route('area_rack.create') }}">
                    ...
                    <tbody>
                        {{-- @foreach ($area_racks as $area_rack)
                            <tr>
                                ...
                                <td>{{ $area_rack->name }}</td>
                                <td>{{ $area_rack->code }}</td>
                                <td>
                                    <a class="btn btn-info btn-sm"
                                        href="{{ route('area_rack.edit', $area_rack->id) }}"><i
                                            class="bi bi-pencil"></i>
                                    </a>
                                    <a class="btn btn-success btn-sm"
                                        href="{{ route('area_rack.view', $area_rack->id) }}"><i class="bi bi-eye"></i>
                                    </a>
                                    <a class="btn btn-danger btn-icon btn-sm"
                                        href="{{ route('area_rack.destroy', $area_rack->id) }}"><i
                                            class="bi bi-trash"></i>
                                    </a>
                                </td>
                            </tr>

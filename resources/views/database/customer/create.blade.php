                    ...
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="pic_name" name="pic_name"
                                value="{{ old('pic_name') }}" placeholder="Enter PIC name">
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="pic_department" name="pic_department"
                                value="{{ old('pic_department') }}" placeholder="Enter PIC department">
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="pic_phone_work" name="pic_phone_work"
                                value="{{ old('pic_phone_work') }}" placeholder="Enter PIC phone work">
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="pic_phone_mobile" name="pic_phone_mobile"
                                value="{{ old('pic_phone_mobile') }}" placeholder="Enter PIC phone mobile">
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="pic_fax" name="pic_fax"
                                value="{{ old('pic_fax') }}" placeholder="Enter PIC fax">
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="pic_email" name="pic_email"
                                value="{{ old('pic_email') }}" placeholder="Enter PIC email">
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="payment_term" name="payment_term"
                                value="{{ old('payment_term') }}" placeholder="Enter Payment Term">
                        </div>
                    </div>
                </div>
            </div>

            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-4 col-12">
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="category" name="category">
                            ...
                            <option value="OEM" @selected($product->category == 'OEM')>OEM</option>
                            <option value="REM" @selected($product->category == 'REM')>REM</option>
                        </select>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-4 col-12">
                ...
                <div class="col-lg-3 col-sm-4 col-12">
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" class="form-control" rows="1" placeholder="Enter Description" disabled>{{ $product->description }}</textarea>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-4 col-12">
                    <div class="mb-3">
                ...
                <div class="col-lg-3 col-sm-4 col-12">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="part_weight" name="part_weight"
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-4 col-12">
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="have_bom" name="have_bom" value="1"
                            @checked($product->have_bom == 1)>

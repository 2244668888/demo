                    ...
                    <div class="mb-3">
                        ...
                        <div class="m-0">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="group" id="group" value="Direct"
                                    @if (!$supplier->group) checked @endif @checked($supplier->group == 'Direct')>
                                <label class="form-check-label" for="group">Direct</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="group" id="group1"
                                    value="InDirect" @checked($supplier->group == 'InDirect')>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-4 col-12">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="contact_person_telephone"
                            name="contact_person_telephone" value="{{ $supplier->contact_person_telephone }}"
                ...
                <div class="col-lg-3 col-sm-4 col-12">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="contact_person_department"
                            name="contact_person_department" value="{{ $supplier->contact_person_department }}"

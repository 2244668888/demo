...
@endsection
@section('button')
    <a type="button" class="btn btn-info" href="{{ route('area_level.create') }}">
                     ...
                     <tbody>
                       {{-- @foreach ($area_levels as $area_level)
                            <tr>
                                ...
                                <td>{{ $area_level->name }}</td>
                                <td>{{ $area_level->code }}</td>
                                <td>
                                    <a class="btn btn-info btn-sm"
                                        href="{{ route('area_level.edit', $area_level->id) }}"><i
                                            class="bi bi-pencil"></i>
                                    </a>
                                    <a class="btn btn-success btn-sm"
                                        href="{{ route('area_level.view', $area_level->id) }}"><i class="bi bi-eye"></i>
                                    </a>
                                    <a class="btn btn-danger btn-icon btn-sm"
                                        href="{{ route('area_level.destroy', $area_level->id) }}"><i
                                            class="bi bi-trash"></i>
                                    </a>
                                </td>
                            </tr>
